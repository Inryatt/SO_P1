...
int main(int argc, char *argv[])
{
    ...
    { // retorna 0 se estiver LATE, 1 se team 1 ou 2 se team 2
        waitReferee(n, team);
        playUntilEnd(n, team);
    }
...
static int goalieConstituteTeam(int id)
{
    ...
    //para os players, verificar se ha mais 3 jogadores livres e um goalie -- NOT HERE :v
    ...
    else if (sh->fSt.playersArrived >= NUMTEAMPLAYERS)
    {
